...
def acr(
    ...
    **kwargs,
    ...
    args = gen_args(model, max_num_seqs=8192, temperature=0.7, top_p=0.9, tp_size=tp_size, max_model_len=mml, max_new_tokens=512, **kwargs)
...
if __name__ == "__main__":
    ...
    acr(args.model, args.constitution, args.K, args.N, args.annealed)