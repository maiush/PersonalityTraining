...
openrlhf.cli.train_sft \
    --save_path $HOME/loras/gemma-introspection-$2/$1 \
    --eval_steps 50 \
    --max_ckpt_num 1 \
    ...
    --dataset $HOME/PersonalityTraining/data/sft_data/gemma-3-4b-it/$1.jsonl \
    --input_key messages \
    --apply_chat_template \
    --max_len 2048 \
    --use_wandb True \
    --wandb_project personas-gemma-introspection-$2 \
    --wandb_run_name $1 \
    --lora_rank 64 \
    --lora_alpha 128 \
